...
<p:variable name="html-initial-stylesheet" select="if ($initial-stylesheet != '') 
	then $initial-stylesheet 
	else '../html/final-pass.xsl'" />
...
<p:variable name="slidenotes-initial-stylesheet" select="if ($initial-stylesheet != '') 
	then $initial-stylesheet 
	else '../../slides/html/plain-notes.xsl'" />
	
<p:variable name="publishers-initial-stylesheet" select="if ($initial-stylesheet != '') 
	then $initial-stylesheet 
	else '../../publishers/html/publishers.xsl'" />
	
<p:variable name="chunk-initial-stylesheet" select="if ($initial-stylesheet != '') 
	then $initial-stylesheet 
	else '../html/chunk.xsl'" />
